...
ActiveRecord::Schema.define(version: 20220321084411) do
  ...
  add_index "payment_histories", ["user_id", "charge_type", "app_title"], name: "payment_histories_user_charge_title_index", using: :btree
